    ...
    const body = `
      ...
      <body>
          <div class="container">
              ...
              <p>Dear ${fullname},</p>
              <p>We are pleased to inform you that your employee account has been successfully created for the Inventory Management System.</p>
              ...
              <p>Welcome aboard!</p>
              <div class="footer">&copy; ${new Date().getFullYear()} Inventory Management System. All rights reserved.</div>
          </div>
      </body>
      </html>
    `;
...
const updateUserAvatar = async (req, res) => {
  try {
    ...
    const avatarUrl = `/public/temp/${req.file.filename}`;
